...
export class RolecreateComponent implements OnInit {
  ...
  role: Role;
  constructor(
    public _ngbActive: NgbActiveModal,
    private fb: FormBuilder,
    private _roleService: RoleService,
    private _dialogSMG: ToastrComponent
  ) {}
  ...
  getError() {
    if (this.roleForm.get('name').hasError('required'))
      return 'You must enter value';
    return this.roleForm.get('name').hasError('maxlength')
